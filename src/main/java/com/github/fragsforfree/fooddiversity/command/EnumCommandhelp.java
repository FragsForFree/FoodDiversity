...
public enum EnumCommandhelp {
	TITLE("", "Plugin FoodDiversity v1.1.3-Snapshot by FragsForFree"),
	...
	Cmd_Add_Foodtypes("/fooddiversity add foodtype <foodtype> <iteminrow[integer]> <food;food;food>", "create a new foodtype"),
